            ...
            <div className='experiencepagehome'>
                ...
                <div className='exp1'>
                    ...
                    <div className='exp1desc'>
                        ...
                        <div className='exp1date'>(June 2022 - Present)</div>
                        <ul className='exp1exp'>
                            <li>Working under the supervision of Dr. Tapan Gandhi from Electrical Engineering department on application of machine learning in tumor analysis.</li>
                        </ul>
                    </div>
                </div>
                <div className='exp1'>
                    ...
                    <div className='exp1desc'>
                        ...
                        <div className='exp1date'>(May 2022 - Present)</div>
                        <ul className='exp1exp'>
